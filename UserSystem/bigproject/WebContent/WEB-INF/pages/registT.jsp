...
<body>
	...
	<hr>
	<div>
		<form action="doRegistT" method="post" onsubmit="return checkSubmit()">
			<table>
				<tr>
					<td>*账号：</td>
				...
				<tr>
					<td>*密码：</td>
					<td><input type="password" name="t_password" id="password"
						onkeyup="checkPassword()"><span id="s3"></span></td>
				</tr>
				<tr>
					<td>*确认密码：</td>
					<td><input type="password" name="t_password2" id="password2"
