	...
	<div>
		<form action="doUpdate" method="post" onsubmit="return checkSubmit()">
			<table>
				...
				<tr>
					<td>账号：</td>
					<td><input type="text" name="t_username" id="user"
						onkeyup="checkUser()" value="${sessionScope.teacher.t_username}"
						readonly="readonly"><span id="s2"></span></td>
				</tr>
				<tr>
					<td>修改密码：</td>
					<td><a href="updateTPW">点击修改</a></td>
				</tr>
				<tr>
					<td>姓名：</td>
					<td><input type="text" name="t_name" id="name"
						onkeyup="checkName()" value="${sessionScope.teacher.t_name}"
				...
				<tr>
					...
					<td><input type="date" name="birthday" id="birthday"
						value="${sessionScope.teacher.birthday}"></td>
				</tr>
				<tr>
					<td>联系电话：</td>
					<td><input type="text" name="t_phone" id="mobile"
						onkeyup="checkMobile()" value="${sessionScope.teacher.t_phone}"><span
						id="s5"></span></td>
				</tr>
			</table>
